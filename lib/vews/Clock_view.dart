...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var outlinBrush = Paint()
      ..color = Color(0xFFEAECFF)
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width / 20;
    var CenterFillBrsh = Paint()..color = Color(0xFFEAECFF);
    //end brush for bent
    //Start brush minute
    ...
    canvas.drawCircle(center, radius * 0.75, outlinBrush);
    ...
    canvas.drawCircle(center, radius * 0.12, CenterFillBrsh);
